...
# Anomaly Detection with Text Anchors
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.ANOMALY_DETECT.PREC = "fp32"          # fp16, fp32, amp
    cfg.TRAINER.ANOMALY_DETECT.LAMBDA_CONSIST = 0.5   # weight for L_consist
    cfg.TRAINER.ANOMALY_DETECT.THRESHOLD_STD = 1.5    # adaptive threshold: μ + k*σ
    cfg.TRAINER.ANOMALY_DETECT.PATCH_TEMPERATURE = 0.07  # temperature for patch-text softmax
